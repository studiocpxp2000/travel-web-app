...
export default function Register() {
    ...
    const enabledFieldKeys = organization?.settings?.registration_fields || organization?.registration_fields || ['name', 'email', 'password'];

    // Get the full field config for enabled fields (exclude password if auto-generated by logic, but usually required)
    // Get the full field config for enabled fields
    ...
    const validate = () => {
        ...
        formFields.forEach(field => {
            ...
            if (field.key === 'email') {
                ...
                // Generic required validation for all other fields
