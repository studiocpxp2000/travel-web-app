                ...
                <div className="card">
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        ...
                        <div className="text-sm text-blue-700 space-y-1">
                            <p><span className="font-medium">Email:</span> yash@gmail.com</p>
                            {/* <p><span className="font-medium">Password:</span> {orgSlug}123</p> */}
                            <p><span className="font-medium">Password:</span> travel-adventures</p>

                        </div>
                        <button
                            type="button"
                            onClick={() => setFormData({ identifier: 'yash@gmail.com', password: `travel-adventures` })}
