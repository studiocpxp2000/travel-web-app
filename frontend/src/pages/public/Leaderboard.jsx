        ...
        <div className="py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-4xl font-bold text-dark-900 mb-4">Leaderboard</h1>
                ...
                <div className="flex justify-center items-end gap-4 mb-12">
                    ...
                    <div className="text-center">
                        ...
                        <div className="w-24 h-20 bg-gradient-to-t from-gray-300 to-gray-200 rounded-t-lg flex items-center justify-center">
                            <span className="text-2xl font-bold text-gray-600">2</span>
                        </div>
                        <div className="bg-white p-2 rounded-b-lg shadow">
                            <p className="font-medium text-sm truncate">{leaderboardData[1].name}</p>
                    ...
                    <div className="text-center">
                        ...
                        <div className="w-28 h-28 bg-gradient-to-t from-yellow-400 to-yellow-300 rounded-t-lg flex items-center justify-center relative">
                            <Trophy className="w-8 h-8 text-yellow-700 absolute -top-4" />
                            <span className="text-3xl font-bold text-yellow-700">1</span>
                        </div>
                        <div className="bg-white p-3 rounded-b-lg shadow">
                            <p className="font-semibold truncate">{leaderboardData[0].name}</p>
                            <p className="text-sm text-primary-600 font-bold">{leaderboardData[0].points} pts</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="w-24 h-16 bg-gradient-to-t from-orange-400 to-orange-300 rounded-t-lg flex items-center justify-center">
                            <span className="text-2xl font-bold text-orange-700">3</span>
                        </div>
                        <div className="bg-white p-2 rounded-b-lg shadow">
                            <p className="font-medium text-sm truncate">{leaderboardData[2].name}</p>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    <th className="text-left py-3 px-4 text-xs font-semibold text-text-light uppercase">Rank</th>
                                    <th className="text-left py-3 px-4 text-xs font-semibold text-text-light uppercase">Player</th>
                                    <th className="text-right py-3 px-4 text-xs font-semibold text-text-light uppercase">Games</th>
                                    <th className="text-right py-3 px-4 text-xs font-semibold text-text-light uppercase">Points</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr key={player.rank} className={`border-b border-gray-100 ${idx < 3 ? 'bg-yellow-50/50' : ''}`}>
                                        ...
                                        <td className="py-4 px-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="font-medium text-dark-900">{player.name}</span>
                                            </div>
                                        </td>
                                        <td className="py-4 px-4 text-right text-text-light">{player.games}</td>
                ...
                <div className="grid grid-cols-3 gap-4 mt-8">
                    <div className="card text-center">
                        ...
                        <p className="text-2xl font-bold text-dark-900">2,850</p>
                        <p className="text-sm text-text-light">Highest Score</p>
                    </div>
                    <div className="card text-center">
                        <Trophy className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
                        <p className="text-2xl font-bold text-dark-900">158</p>
                        <p className="text-sm text-text-light">Total Players</p>
                    </div>
                    <div className="card text-center">
                        <Award className="w-8 h-8 text-purple-500 mx-auto mb-2" />
                        <p className="text-2xl font-bold text-dark-900">1,234</p>
                        <p className="text-sm text-text-light">Games Played</p>
                    </div>
                </div>
            </div>
        </div>
